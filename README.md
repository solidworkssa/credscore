# 23-credscore - Base Native Architecture
...
CredScore provides a decentralized solution for on-chain credit history and scoring on both Base (EVM) and Stacks blockchains.
